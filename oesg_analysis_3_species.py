...
species_list = ['TGM','GEM','GOM'] # species list
...
for species in species_list:
    ...
    for ipcc_region in ipcc_regions_list:#ipcc_analysis_df.index:
        ...
        sql_data_query = """
                        set time zone GMT;
                        select datetime, site, concentration from all__hgee_v2 where (IPCC_region = '{}' and species = '{}' and datetime > '2010-01-01' and concentration is not null and concentration >=0 and concentration < 500 and flag_des is null) order by datetime;
        ...
        mercury_df.set_index(mercury_df['datetime'], drop=True, inplace=True)
        ...
        # split out the full time series into monthly sub-sections
            ...
            def mann_kendall(mercury_df):
                ...
                time_span = mercury_df.index[-1]-mercury_df.index[0] # grab the time span between start and end times
                print (time_span)
                ...
                if time_resolution < pd.Timedelta(days=1):
                    ...
                    sub_sample_resolution = (time_span/1000).round('d') # calculate the sub-sample interval based on 1000 ev
                    print (sub_sample_resolution)
                    ...
                    # print ('data have been resampled at 1 day resolution')
                    # print (mercury_sub_sampled_concentration_series.shape)               
